    ...
    >
      <div className="flex flex-col items-center justify-center h-full w-full">
        <div className="flex h-[80%] w-[80%] flex-col items-center justify-evenly">
          ...
          <span className="flex justify-between p-3 border-[1px] border-outline-gray rounded-lg w-full">
...
const AddressBar = ({
  ...
  return (
    <button
      onClick={toggleModal}
      className="bg-primary py-2 px-4 text-white rounded-lg transition duration-300"
    >
      {
